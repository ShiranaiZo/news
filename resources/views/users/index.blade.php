                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="buttons">
                                        ...
                                        <button type="button" class="btn icon btn-danger tooltip-class" data-bs-placement="right" title="Remove" data-bs-toggle="modal" data-bs-target="#modal_remove" onclick="modalRemove('{{ url('admin/users/'.$user->id) }}')" {{ Auth::user()->id == $user->id ? 'disabled' : '' }}>
